          ...
          <CCardBody>
            <CForm>
              ...
              <template v-for="(name, key) in checkboxNames">
                <CRow :key="name" form class="form-group">
      ...
      <CCol sm="4">
        <CCard>
          ...
          <CCardBody>
            <CInput placeholder="Username">
              <template #prepend>
                <CDropdown toggler-text="Action" color="primary">
            ...
            <CInput type="email" placeholder="Email" autocomplete="email">
              <template #append>
                <CDropdown toggler-text="Action" color="primary" right>
                  <CDropdownItem>Action</CDropdownItem>
                  <CDropdownItem>Another action</CDropdownItem>
                  <CDropdownItem>Something else here...</CDropdownItem>
                  <CDropdownItem disabled>Disabled action</CDropdownItem>
            ...
            <CInput placeholder="...">
              <template #prepend>
                <CDropdown toggler-text="Split" color="primary" split>
