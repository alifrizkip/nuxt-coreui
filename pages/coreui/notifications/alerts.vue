  ...
  <CRow>
    ...
    <CCol col="12" md="6">
      <CCard>
        ...
        <CCardBody>
          <CAlert color="secondary" close-button :show.sync="alert1">
            Dismissible Alert!
          </CAlert>
          ...
          <CButton color="info" class="m-1" @click="showDismissibleAlerts">
      ...
      <CCard>
        ...
        <CCardBody>
          <div>
            ...
            <CAlert :show.sync="dismissCountDown" close-button color="info">
